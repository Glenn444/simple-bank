...
func (m *MockStore) CreateUsers(ctx context.Context, arg database.CreateUsersParams) (database.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetUser(ctx context.Context, username string) (database.User, error) {
	m.ctrl.T.Helper()
